...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "WissToken " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"wisstoken.zapto.org", "wisstoken.zapto.org"},
    {"seed1.wisstoken.org", "seed1.wisstoken.org"},
    {"seed2.wisstoken.org", "seed2.wisstoken.org"},
    {"seed1.wisstoken.com", "seed1.wisstoken.com"},
    {"seed2.wisstoken.com", "seed2.wisstoken.com"},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. WissToken is probably already running."), addrBind.ToString().c_str());
        else
